...
const SEVERITY: Record<string, { color: string; bg: string; label: string; icon: string }> = {
  ...
  warning: { color: '#e8c14a', bg: 'rgba(232,193,74,.10)', label: 'Atención', icon: '!' },
              ...
              <AreaChart data={savings.series}>
                <defs>
                  <linearGradient id="savGrad" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#2ee88f" stopOpacity={0.32} />
                ...
                <Area type="monotone" dataKey="cumulative" stroke="#2ee88f" strokeWidth={2} fill="url(#savGrad)" />
              </AreaChart>
            </ResponsiveContainer>
