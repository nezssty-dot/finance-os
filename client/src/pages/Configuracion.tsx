        ...
        <div className="grid gap-4">
          <Card title="Apariencia">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-[14px] font-semibold">Tema de la interfaz</div>
                <div className="text-[12.5px] text-txt-3 mt-0.5">Elegí cómo se ve Finance OS.</div>
              </div>
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-[13px] font-semibold border transition-colors ${
                    theme === 'light'
                      ...
                      : 'bg-panel-2 text-txt-2 border-line hover:border-line-2'
                  }`}
                >
                  ☀ Claro
                </button>
